 ...
 * {@code endOfInput()}).
 *
 * Tests for GHSA-r7wm-3cxj-wff9 (incomplete fix for GHSA-72hv-8253-57qq).
 *
 * @since 2.12.7
 */
public class AsyncNumberLengthConsistencyTest
    extends BaseTest
{
    // Matches StreamReadConstraints' default max number length, which is what
    // the default stream factory applies.
